...
<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
  ...
  <div class="w3-row-padding w3-padding-16 w3-center" id="cat">
    <div class="w3-quarter">
      <img src="img/AmericanShortHair.jpg" alt="AmericanShortHair" style="width:100%">
    ...
    <div class="w3-quarter">
      <img src="img/British Shorthair.jpg" alt="British Shorthair" style="width:100%">
      <h3>2. บริติช ช็อตแฮร์ (British Shorthair)</h3>
      <p>มีนิสียเงียบ เรียบง่ายและนิ่งเฉย ไม่ค่อยกระตือรือร้น</p>
    </div>
    <div class="w3-quarter">
      <img src="img/ScottishFold.jpg" alt="ScottishFold" style="width:100%">
  ...
  <div class="w3-row-padding w3-padding-16 w3-center">
    <div class="w3-quarter">
      <img src="img/Bengal.jpg" alt="Bengal" style="width:100%">
      <h3>5. เบงกอล (Bengal)</h3>
      <p>นิสัยเชื่อมั่นในตัวเอง ชอบการเล่น และชอบกิจกรรมที่ต้องใช้พลังงาน</p>
    </div>
    <div class="w3-quarter">
      <img src="img/AmericanCurl.jpg" alt="Salmon" style="width:120%">
      <h3>6. อเมริกัน เคิร์ล (American Curl)</h3>
      <p>นิสัยเป็นมิตร ชอบเล่น รักในการเรียนรู้และมีความฉลาด</p>
    </div>
    <div class="w3-quarter">
      <img src="img/ExoticShorthair.jpg" alt="Sandwich" style="width:80%">
      <h3>7. เอ็กโซติก ช็อตแฮร์ (Exotic Shorthair)</h3>
      <p>นิสัยชอบเล่น อ่อนโยน และมีความรัก ความอุ่นใจต่อคน</p>
    </div>
    <div class="w3-quarter">
      <img src="img/Persian.jpg" alt="Croissant" style="width:90%">
